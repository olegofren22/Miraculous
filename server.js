...
async function initializeApp() {
    try {
        ...
        try {
            ...
            globalSpinnerConfig = {
                spinnerId: parsed.spinnerId || 7030,
                packIds: parsed.packIds || [11953, 12053, 12079, 12121, 12145, 12316, 14356]
            };
...
app.post('/api/spinner-config', async (req, res) => {
    ...
    if (spinnerId !== undefined) {
        globalSpinnerConfig.spinnerId = parseInt(spinnerId) || 7030;
    }
